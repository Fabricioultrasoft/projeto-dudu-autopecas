...
type
   ...
   public
      ...
      function getStatusConexao(var SQLConexao: TSQLConnection): Boolean;
   end;
...
function TConexao.getStatusConexao(var SQLConexao: TSQLConnection): Boolean;
begin
    try
        Self.Conectar(SQLConexao);
        SQLConexao.Open;
     ...
     Except
        on E:Exception do
        ShowMessage('Erro ao testar conexão!'#13#10 + E.Message);
     end;
end;
